...
<?php } else { ?>
    <div class="ossn-topbar">
        <div class="inner">
			...
			<li>
			<a href="<?php echo ossn_site_url('administrator'); ?>"><?php echo ossn_print('dashboard'); ?></a>
			</li>
			 <li>
                            <a href="http://molnarvilmos.hu/webmail">WebMail</a>
                        </li>
			<?php } ?>
                        <li>
                          <?php
...
<div class="ossn-footer">
    <div class="ossn-footer-inner">
        ...
        &copy;  <a href="<?php echo ossn_site_url(); ?>"><?php echo $sitename; ?></a> 
		          <?php echo date('Y'); ?> -
                  <a target="_blank" href="https://www.facebook.com/molnarvilmos.hu"><?php echo ossn_print('powered');?></a>        
        </div>
